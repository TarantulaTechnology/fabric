...
#    @doNotDecompose
  ...
  Scenario: Range query test, single peer, issue #767
    Given we compose "docker-compose-1.yml"
      ...
      When I deploy chaincode "github.com/TarantulaTechnology/fabric/examples/chaincode/go/map" with ctor "init" to "vp0"
      ||
      ||
...
# @doNotDecompose
  ...
  Scenario: chaincode shim table API, issue 477
    Given we compose "docker-compose-1.yml"
      When requesting "/chain" from "vp0"
      Then I should get a JSON response with "height" = "1"
      When I deploy chaincode "github.com/TarantulaTechnology/fabric/bddtests/chaincode/go/table" with ctor "init" to "vp0"
      ||
      ||
      Then I should have received a chaincode name
      Then I wait up to "60" seconds for transaction to be committed to all peers
...
#    @wip
	Scenario: chaincode example 02 single peer
	    ...
	    When requesting "/chain" from "vp0"
	    Then I should get a JSON response with "height" = "1"
	    When I deploy chaincode "github.com/TarantulaTechnology/fabric/examples/chaincode/go/chaincode_example02" with ctor "init" to "vp0"
		     | arg1 |  arg2 | arg3 | arg4 |
		     |  a   |  100  |  b   |  200 |
	    Then I should have received a chaincode name
	    Then I wait up to "60" seconds for transaction to be committed to all peers
...
#      Then I should get a JSON response with "height" = "1"
      ...
      # Deploy
      When I deploy chaincode "github.com/TarantulaTechnology/fabric/examples/chaincode/go/chaincode_example02" with ctor "init" to "nvp0"
                    | arg1 |  arg2 | arg3 | arg4 |
                    |  a   |  100  |  b   |  200 |
      Then I should have received a chaincode name
      Then I wait up to "<WaitTime>" seconds for transaction to be committed to peers:
